...
import { ZapIcon, TargetIcon, HandshakeIcon } from "@/components/Icons";
      ...
      <section className="section vision">
        <div className="container">
          ...
          <div className="vision-grid">
            <article className="vision-card" data-advantage="cepat">
            ...
            <article className="vision-card" data-advantage="tanggap">
              <div className="vision-icon" style={{ color: 'var(--gold)' }}>
                <TargetIcon size={30} />
              </div>
              <h3>Tanggap</h3>
            ...
            <article className="vision-card" data-advantage="tanggung-jawab">
              <div className="vision-icon" style={{ color: 'var(--gold)' }}>
